...
백엔드: [GoldenMine0502/BusRouteFinderBackend: 토이프젝](https://github.com/GoldenMine0502/BusRouteFinderBackend)
...
로그인시, 버스 경로를 저장할 수 있습니다. rest api는 존재하지만 UI상 회원 가입 기능은 없습니다. (또는 관리자 페이지 들어가서 만들 수 있습니다) 
...
사실 수업은 핑계고 그냥 코드가 더럽습니다. 저도 불만족스럽네요
